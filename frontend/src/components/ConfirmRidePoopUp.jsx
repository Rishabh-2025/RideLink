...
const ConfirmRidePoopUp = ({setConfirmRidePoopUpPanel,setRidePopUpPanel}) => {
  return (

       <div >
   
               <h5 className='p-3 text-center absolute top-0 w-[93%]  flex items-center justify-center' onClick={() => {setConfirmRidePoopUpPanel(false)}}>
               ...
               <div className=' flex flex-col gap-4 justify-between items-center'>
                   ...
                   <div className='flex w-full items-center mt-2 gap-3'>
                       <button onClick={() => {
                        ...
                        }} className='w-1/2 bg-[#007dfe]  text-white font-semibold p-2 rounded-lg'>Confirm</button>
   
                       <button onClick={() => {
                        setConfirmRidePoopUpPanel(false),
...
export default ConfirmRidePoopUp