...
const ConfirmRide = ({ createRide, pickup, destination, fare, vehicleType, setConfirmRidePanel, setVehicleFound }) => {
    ...
    return (
        <div>
            ...
            <h5 className='p-3 text-center absolute top-0 w-[93%]  flex items-center justify-center' onClick={() => setConfirmRidePanel(false)}>
            ...
            <div className=' flex flex-col gap-4 justify-between items-center'>
                ...
                <button onClick={() => { setVehicleFound(true), setConfirmRidePanel(false), createRide() }} className='w-full bg-[#007dfe] mt-5 text-white font-semibold p-2 rounded-lg'>Confirm</button>
