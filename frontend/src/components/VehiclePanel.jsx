...
const VehiclePanel = ({setConfirmRidePanel,setVehiclePanel}) => {
    return (
        <div>
            ...
            <div onClick={()=>setConfirmRidePanel(true)} className='flex border-2 mb-3 active:border-black  rounded-xl  w-full items-center justify-between p-3'>
                ...
                <h2 className='text-xl font-semibold'>&#8377;193.33</h2>
            </div>
